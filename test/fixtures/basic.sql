...
INSERT INTO "tbl_component_def" VALUES(3,'/component/human_name','{"id":"/component/name","properties":{"first_name":{"type":"string"},"last_name":{"type":"string"}},"additionalProperties":true}',0,0,NULL,NULL,NULL,NULL);
...
DROP TABLE IF EXISTS "tbl_component_name";
CREATE TABLE tbl_component_name( id INTEGER PRIMARY KEY, entity_id INTEGER, first_name STRING, last_name STRING, _additional STRING, _status INTEGER, _created_at DATETIME DEFAULT CURRENT_TIMESTAMP, _created_by INTEGER, _updated_at DATETIME DEFAULT CURRENT_TIMESTAMP, _updated_by INTEGER);
INSERT INTO "tbl_component_name" VALUES(1,1,'charlie','fixture','{"location":"flatland"}',0,'2013-10-08T11:48:47.917Z',0,'2013-10-08T11:48:47.917Z',0);
